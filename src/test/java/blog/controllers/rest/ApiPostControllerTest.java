package blog.controllers.rest;

import blog.controller.ApiAuthController;
...
public class ApiPostControllerTest {
    ...
    public void getPostsByTag() {
        mvc.perform(get(basePath + "/byTag")
                .param("offset", "0")
                .param("limit", "10")
                .param("tag", "JAVA"))
                .andDo(print())
    ...
    public void getPostsByDate() {
        mvc.perform(get(basePath + "/byDate")
                .param("offset", "0")
                .param("limit", "10")
    ...
    public void addNewPost() {
        ...
        AddPostDto addPostDto = new AddPostDto
                ("2020-06-16 13:15", (byte) 1, "test", "mnogotestamnogotesta", tags);
    ...
    public void postsToModeration() {
        mvc.perform(get(basePath + "/moderation")
                .session(session)
                .param("offset", "0")
                .param("limit", "10")
                .param("status", "new"))
    ...
    public void takeLikeToPost() {
        ...
        mvc.perform(post(basePath + "/like")
                .session(session)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json))
                .andDo(print())
    ...
    public void takeDislikeToPost() {
        ...
        String json = om.writeValueAsString(likeOrDislikeDto);
        mvc.perform(post(basePath + "/dislike")
                .session(session)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json))
                .andDo(print())
