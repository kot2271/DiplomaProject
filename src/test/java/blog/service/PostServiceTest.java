...
import blog.dto.responseDto.CalendarDto;
import blog.dto.responseDto.OnePostDto;
import blog.dto.responseDto.PostDto;
import blog.dto.responseDto.PostListDto;
...
public class PostServiceTest {
    ...
    public void getPostsByTag(){
        List<PostDto> postDtoList = postService.getPostByTag("JAVA", 0, 10);
    ...
    public void getCountPostsByTag(){
        Integer count = postService.getCountPostByTag("WORLD");
    ...
    public void addNewPost(){
        ...
        tags.add("TEST");
        tags.add("PAIN");
        AddPostDto addPostDto = new AddPostDto("2020-06-14 17:00", (byte)1, "offline test",
                "tests = a lot of pain and work", tags);
        User user = new User();
    ...
    public void editPostById(){
        ...
        AddPostDto addPostDto = new AddPostDto("2020-06-14 17:00", (byte)1, "offline test",
                "tests = a lot of pain and work", new ArrayList<>());
